...
class Membership extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Scaffold(
      //appBar: EventAppBar(title: 'Membership'),
      //bottomNavigationBar: DefaultTabController(length: 10,animationDuration: Duration(seconds: 2), child: MyTabBar(),),
    
        
      
    body: Center(child: Text('Membership',style: TextStyle(fontSize: 100),)),//Center(child: Text('Hello',style: TextStyle(fontSize: 100, ),))
