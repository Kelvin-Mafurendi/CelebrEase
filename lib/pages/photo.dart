...
class Photos extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Scaffold(
      appBar: EventAppBar(title: 'Photos'),
      //bottomNavigationBar: DefaultTabController(length: 10,animationDuration: Duration(seconds: 2), child: MyTabBar(),),
    
        
      
    body: Center(child: Text('Photography and Videography',style: TextStyle(fontSize: 50),)),//Center(child: Text('Hello',style: TextStyle(fontSize: 100, ),))
