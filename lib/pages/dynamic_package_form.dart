...
class _DynamicPackageFormState extends State<DynamicPackageForm> {
  ...
  void _initializeControllers() {
    ...
    if (selectedServiceType != null && serviceFieldsget.containsKey(selectedServiceType)) {
  ...
  final Map<String, List<String>> rateUnits = {
    ...
    'Food and Catering': ['per person', 'per event', 'per hour'],
      ...
      children: fields.map((field) {
        ...
        return Padding(
          ...
          child: TextFormField(
            ...
            validator: (value) {
              if (value == null || value.isEmpty) {
                return 'Please enter ${_formatFieldLabel(field)}';
              }
              return null;
            },
          ),
